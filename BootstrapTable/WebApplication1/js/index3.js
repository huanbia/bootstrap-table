...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_departments').bootstrapTable({
            ...
            search: function(){alert("here")},                       //是否显示表格搜索，此搜索是客户端搜索，不会进服务端，所以，个人感觉意义不大
            strictSearch: true,
...
var ButtonInit = function () {
    ...
    oInit.Init = function () {
        $("#btn_add").click(function () {
            ...
            if (selectItems.length > 0) {
                ...
                selectItems.forEach(function (item) {
                    tempSelect += item.Name
                    tempSelect += " "
                })
                var params = { index: 0, row: { "Name": tempSelect, "ParentName": 1, "Level": 1, "Desc": 1} };
        ...
        $("#btn_delete").click(function () {
            ...
            window.Ewin.confirm({ message: "确认要删除选择的数据吗？" }).on(function (e) {
                if (!e) {
                    return;
                }
                $.ajax({
